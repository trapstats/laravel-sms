...
use Trapstats\Sms\Transport\SnsTransport;
...
class SmsManager implements SmsFactory
{
    ...
    /**
     * Create an instance of the Amazon SNS Transport driver.
     *
     * @param  array  $config
     * @return \Trapstats\Sms\Transport\SnsTransport
     */
    protected function createSnsTransport(array $config): SnsTransport
    {
        $config = array_merge(
            $this->app['config']->get('services.sns', []),
            ['version' => 'latest'],
            $config
        );
